...
class InfoPanel extends ComponentTree.Component {
  ...
  render() {
    ...
    return <div className="info-panel">
      <p className="large-text">Flatris4 is demo app for the <a href="https://github.com/skidding/cosmos">Cosmos</a> project, built using <a href="https://github.com/facebook/react">React</a> components.</p>
